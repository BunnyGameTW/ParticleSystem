...
void CParticle::setBehavior(int iType)
{
	...
	case STARSHAPE:
		...
		_Direction.x = sint*sint*sint;
		_Direction.y = cost*cost*cost;
		_fLifeTime = 1.5f + LIFE_NOISE(0.15f);
		_fIntensity = 1;
		_fOpacity = 255;
		_fSpin = 0;
...
//void CParticle::setSize(const float fSize) {
//	_fSize=fSize;
//}
