...
private:
	...
	cocos2d::ui::TextBMFont *_EmitterTypeBMValue;//emitter type
	cocos2d::ui::TextBMFont *_SizeBMValue;//size
...
public:
	...
	void SizeEvent(cocos2d::Ref* sender, cocos2d::ui::Slider::EventType type);//size event
